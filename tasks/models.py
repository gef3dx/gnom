...
class Tasks(models.Model):
    ...
    status = models.CharField(verbose_name="Статус задачи", max_length=50, choices=STATUS_CHOICES, default="В ходе выполнения")
    user = models.ForeignKey(CustomUser, verbose_name="Выполняют задачу", on_delete=models.PROTECT)
