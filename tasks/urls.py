...
from tasks.views import TasksCreateView, TasksUpdateView, TasksDeleteView, ObjectListView, ObjectUsersListView,\
    TaskUserListView, SingleTaskView, ExplanationsUpdateView
...
urlpatterns = [
    ...
    path('add/object/<int:object_id>/user/<int:user_id>/', TasksCreateView.as_view(), name='addtask'),
    path('update/<int:pk>/', TasksUpdateView.as_view(), name='updatetask'),
    path('delete/<int:pk>/', TasksDeleteView.as_view(), name='deletetask'),
    path('explanations/<int:pk>/', ExplanationsUpdateView.as_view(), name='explanationstask'),
]
